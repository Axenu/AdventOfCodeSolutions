input_data = '''1236	741	557	1029	144	101	1968	2159	1399	80	1139	1167	1695	82	90	2236
    ...
    for i in values:
        ...
        for j in values:
            if i != j:
                ...
                # print j
                # print num/num2
                if int(num/num2) == num/num2:
                    sum += (num/num2)
                    # print sum
                    found = True
                elif int(num2/num) == num2/num:
                    sum += (num2/num)
                    # print sum
                    found = True
...
lines = []
for row in rows:
    lines.append(map(int, string.split(row.strip(), '\t')))
