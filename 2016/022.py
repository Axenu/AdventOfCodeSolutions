input_data='''root@ebhq-gridcenter# df -h
...
for x in xrange(0, len(spaces)):
    for y in xrange(0, len(spaces)):
        if x != y:
            if spaces[x][0] != 0:
                if spaces[y][1] >= spaces[x][0]:
                    count += 1
...
for y in xrange(0, 28):
    ...
    for x in xrange(0, 38):
        # print x*28+y
        # print spaces[x*28+y]
        # print spaces[x*28+y][0]
        if x == 37 and y == 0:
            row += 'G'
        elif spaces[x*28+y][0] > 80:
            row += '#'
        elif spaces[x*28+y][0] == 0:
            row += '_'
        else:
            row += '.'
    print row
