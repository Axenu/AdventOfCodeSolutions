input_data = '''rhamaeovmbheijj[hkwbkqzlcscwjkyjulk]ajsxfuemamuqcjccbc
...
# input_data = 'zazbz[bzb]cdb'

def containABBA(text):
...
for row in rows:
    ...
    supernet.append(parts.pop(0))
    # ntainABBA(parts.pop(0))
    for part in parts:
        s = part.split(']')
        supernet.append(s[1])
        hypernet.append(s[0])
    ...
    for part in supernet:
        abas = abas + findABA(part)

    print abas
    for part in abas:
        for p in hypernet:
            pp = part[1] + part[0] + part[1]
            if pp in p:
                found = True
                print p
                print pp
...
#     parts = row.split('[')
#
    # possible = containABBA(parts.pop(0))
    # for part in parts:
    #     s = part.split(']')
    #     if containABBA(s[0]):
    #         inBracket = True
